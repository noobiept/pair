...
export module Menu {
    ...
    export function init({ config, restartGame }: MenuArgs) {
        ...
        let columnsValue = <HTMLSpanElement>(
        ...
        // images used
        let imagesUsed = <HTMLInputElement>(
            document.getElementById('ImagesUsed')
        );
        let imagesUsedValue = <HTMLSpanElement>(
            document.getElementById('ImagesUsedValue')
        );
